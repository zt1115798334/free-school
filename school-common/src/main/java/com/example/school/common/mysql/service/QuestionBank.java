 ...
 * description:
 */
public interface QuestionBank extends Base<com.example.school.common.mysql.entity.QuestionBank, Long> {

    RoQuestionBank saveQuestionBank(com.example.school.common.mysql.entity.QuestionBank questionBank);
    ...
    com.example.school.common.mysql.entity.QuestionBank findQuestionBank(Long id) ;

    RoQuestionBank findRoQuestionBank(Long id, Long userId) ;

    PageImpl<RoQuestionBank> findQuestionBankEffectivePage(com.example.school.common.mysql.entity.QuestionBank questionBank, Long userId);

    PageImpl<RoQuestionBank> findQuestionBankUserPage(com.example.school.common.mysql.entity.QuestionBank questionBank, Long userId);
