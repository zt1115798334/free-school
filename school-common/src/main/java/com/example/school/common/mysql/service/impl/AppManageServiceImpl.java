...
public class AppManageServiceImpl implements AppManageService {
    ...
    public AppManage save(AppManage appManage) {
    ...
    private void deleteAppManager(String systemType) {
        Optional<AppManage> manageOptional = appManageRepository.findBySystemTypeAndDeleteState(systemType, UN_DELETED);
    ...
    @Override
    @Transactional(rollbackOn = RuntimeException.class)
    public AppManage saveAppManager(AppManage appManage) {
    ...
    @Override
    public AppManage findAppManager(String systemType) {
    ...
    @Override
    public AppManage saveAppManager(HttpServletRequest request) throws IOException {
        ...
        if (multipartResolver.isMultipart(request)) {
            ...
            if (appFile != null) {
                ...
                if (StringUtils.isNotEmpty(originalFileName)) {
                    ...
                    AppManage appManage = new AppManage(systemType, version, versionCode, newName, tarPath, content);
    ...
    public void downAppFile(HttpServletRequest request, HttpServletResponse response) throws Exception {
        AppManage appManage = this.findAppManager(SysConst.AppSystemType.ANDROID.getType());
