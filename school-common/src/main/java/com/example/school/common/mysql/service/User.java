 ...
 * description:
 */
public interface User extends Base<com.example.school.common.mysql.entity.User, Long> {
    ...
    RoUser saveUser(com.example.school.common.mysql.entity.User user);
    ...
    Optional<com.example.school.common.mysql.entity.User> findOptByUserId(Long userId);

    Optional<com.example.school.common.mysql.entity.User> findOptByAccount(String account);

    Optional<com.example.school.common.mysql.entity.User> findOptByPhone(String phone);

    com.example.school.common.mysql.entity.User findByPhoneUnDelete(String phone);

    com.example.school.common.mysql.entity.User findByUserId(Long userId);
