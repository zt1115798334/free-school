...
public class SignRecordImpl implements SignRecord {
    ...
    public void signIn(Long userId) {
        ...
        Optional<com.example.school.common.mysql.entity.SignRecord> signRecordOptional = signRecordRepository.findByUserIdAndDateMonth(userId, firstDay);
        if (signRecordOptional.isPresent()) {
            com.example.school.common.mysql.entity.SignRecord signRecord = signRecordOptional.get();
            ...
            com.example.school.common.mysql.entity.SignRecord signRecord = new com.example.school.common.mysql.entity.SignRecord(userId, firstDay, dayOfMonthBinary, 1);
            signRecordRepository.save(signRecord);
        }
    ...
    public List<JSONObject> signInCalendar(Long userId, LocalDate dateMonth) {
        Optional<com.example.school.common.mysql.entity.SignRecord> signRecordOptional = signRecordRepository.findByUserIdAndDateMonth(userId, dateMonth);
